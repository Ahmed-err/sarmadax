        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-foreground">{t("challengeTitle")}</h2>
            </div>
            <p className="text-base leading-relaxed text-text-secondary">{t("challenge")}</p>
          </motion.div>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-foreground">{t("solutionTitle")}</h2>
            </div>
            <p className="text-base leading-relaxed text-text-secondary">{t("solution")}</p>
          </motion.div>
